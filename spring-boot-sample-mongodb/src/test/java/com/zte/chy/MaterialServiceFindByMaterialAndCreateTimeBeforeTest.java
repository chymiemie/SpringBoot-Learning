...
public class MaterialServiceFindByMaterialAndCreateTimeBeforeTest {
	@Autowired
	...
	public void test() throws ParseException {
		...
		System.out.println("==========>   materialService.findByMaterialAndCreateTimeBefore(materialcode, endTime)");
		List<Material> list = materialService.findByMaterialAndCreateTimeBefore(materialcode, endTime);
		list.parallelStream().forEach(System.out::println);
		System.out.println("==========>   findByMaterialAndCreateTimeBefore(materialPage);");
		MaterialPage materialPage = new MaterialPage(materialcode, startTime, endTime, barcode);
		Page<Material> page = materialService.findByMaterialAndCreateTimeBefore(materialPage);
